...
#Crear vista para saber la vulnerabilidad de los barrios
cursor.execute("""
    CREATE OR REPLACE VIEW public.vulnerabilidad_distritos AS
    SELECT 
        distrito, 
        indice_global as indice_vulnerabilidad,
        vulnerabilidad_global as vulnerabilidad_distrito
    FROM public."vulnerabilidad_barrios"
    ORDER BY distrito;
""")
