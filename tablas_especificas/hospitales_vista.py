...
# Recorrer los documentos de MongoDB e insertar datos en PostgreSQL
...
# Crear una vista para contar los centros de salud por distrito
cursor.execute("""
    CREATE OR REPLACE VIEW public.hospitales_distritos AS
    SELECT 
        district_id, 
...
# Mensaje de éxito
print("Datos insertados correctamente y vista creada.")
