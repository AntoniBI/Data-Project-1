...
# def main():
#     st.title("Mapa de Distritos en Valencia")
#     st.write("Este mapa muestra las áreas de los distritos en Valencia.")

#     # Cargar los datos desde la base de datos
#     data = load_distritos()

#     if data.empty:
#         st.warning("No se pudieron cargar los datos de los distritos.")
#         return
