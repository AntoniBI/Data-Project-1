...
def calcular_color(precio_filtrado, puntuacion_total):
    ...
    if not precio_filtrado:
        ...
        # Verificar si puntuacion_total es NaN, y si lo es, asignar un valor predeterminado
        if pd.isna(puntuacion_total):
            puntuacion_total = 0  # O cualquier otro valor predeterminado que tenga sentido
